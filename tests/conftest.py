...
# Em CI, defina explicitamente se quiser testar caminhos onde a var DEVE faltar.
...
# Desativa rate limit globalmente nos tests — caso contrário tests do
# mesmo endpoint compartilham o contador (slowapi é singleton) e o
# 5º request começa a retornar 429 mesmo em testes isolados.
